    ...
    return (
        <View style={ApplicationStyles.mainView}>
            ...
            <ScrollView contentContainerStyle={styles.scrollviewStyle} showsVerticalScrollIndicator={false}>
                ...
                <Text style={styles.termsText1} >By clicking 'Submit', I hereby acknowledge and agree that I have reed and  understood sofra
...
const styles = StyleSheet.create({
    ...
    titleTextStyle: { fontSize: 18, fontWeight: 'bold', color: Colors.black, paddingVertical: 20 },
